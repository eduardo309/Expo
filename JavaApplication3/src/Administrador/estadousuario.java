 ...
 * @author oscar
 */
public class estadousuario extends javax.swing.JFrame {

    /**
     * Creates new form estadousuario
     */
    public estadousuario() {
        initComponents();
        mthestados2 para_actualizar = new mthestados2();
        para_actualizar.tabla_estadousu();
        Sletras(txtestadousu);
        this.setLocationRelativeTo(null);
        this.setTitle("Estados de usuario");//titulo 
    ...
    private void initComponents() {
        ...
        txtestadousu = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();
        tablaestadousu = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Estado del Usuario", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        txtestadousu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtestadousuKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtestadousuKeyTyped(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtcodigousu, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtestadousu, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtestadousu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3))))
                .addGap(36, 36, 36))
        );

        tablaestadousu.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaestadousu.getTableHeader().setReorderingAllowed(false);
        tablaestadousu.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaestadousuMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaestadousu);
        if (tablaestadousu.getColumnModel().getColumnCount() > 0) {
            tablaestadousu.getColumnModel().getColumn(0).setMinWidth(0);
            tablaestadousu.getColumnModel().getColumn(0).setMaxWidth(0);
            tablaestadousu.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(!txtestadousu.getText().isEmpty())
        {

            mthestados2 obj = new mthestados2();

            obj.setNombre(txtestadousu.getText());
            obj.setConsulta("insert into estado_usuario(nombre_estado) values(?)");
            if(obj.guardar_estado())
            {
                ...
                try {
                    DefaultTableModel modelo=(DefaultTableModel) tablaestadousu.getModel();
                    int filas=tablaestadousu.getRowCount();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!txtcodigousu.getText().isEmpty())
        {
            if(!txtestadousu.getText().isEmpty())
            {
                ...
                mthestados2 obj = new mthestados2();
                obj.setCodigo(Integer.parseInt(txtcodigousu.getText()));
                obj.setNombre(txtestadousu.getText());
                obj.setConsulta("update estado_usuario set nombre_estado=? where id_estadousu=?");
    ...
    private void btnEliminar_TUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminar_TUActionPerformed
        ...
        if(!txtcodigousu.getText().isEmpty())
        {
            mthestados2 obj = new mthestados2();
            obj.setCodigo(Integer.parseInt(txtcodigousu.getText()));
            obj.setConsulta("delete from estado_usuario where id_estadousu = ?");
    ...
    private void txtestadousuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtestadousuKeyPressed

    }//GEN-LAST:event_txtestadousuKeyPressed

    private void txtestadousuKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtestadousuKeyTyped

    }//GEN-LAST:event_txtestadousuKeyTyped

    private void tablaestadousuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaestadousuMouseClicked
        Integer ID = (Integer) tablaestadousu.getValueAt(tablaestadousu.getSelectedRow(), 0);
        String Nombre = (String) tablaestadousu.getValueAt(tablaestadousu.getSelectedRow(), 1);

        txtcodigousu.setText(ID.toString());
        txtestadousu.setText(Nombre);
    }//GEN-LAST:event_tablaestadousuMouseClicked

    private void limpiar(){
        txtcodigousu.setText(null);
        txtestadousu.setText(null);
    }
...
//            java.util.logging.Logger.getLogger(estadousuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new estadousuario().setVisible(true);
    ...
    public static javax.swing.JTable tablaestadousu;
    private javax.swing.JTextField txtcodigousu;
    private javax.swing.JTextField txtestadousu;
