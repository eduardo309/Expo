...
public class estadoempleado extends javax.swing.JFrame {
    ...
    public estadoempleado() {
        ...
        para_actualizar.tabla_estadoemp();
        Sletras(txtestadoemp);//se aplica el metodo de validacion de solo letras
        this.setLocationRelativeTo(null);
        this.setTitle("Estados de empleado");//titulo 
    ...
    private void initComponents() {
        ...
        tablaestadoemp = new javax.swing.JTable();
        ...
        tablaestadoemp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaestadoemp.getTableHeader().setReorderingAllowed(false);
        tablaestadoemp.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaestadoempMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaestadoemp);
        if (tablaestadoemp.getColumnModel().getColumnCount() > 0) {
            tablaestadoemp.getColumnModel().getColumn(0).setMinWidth(0);
            tablaestadoemp.getColumnModel().getColumn(0).setMaxWidth(0);
        }

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Estado del empleado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        txtestadoemp.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtestadoempKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtestadoempKeyTyped(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtcodigoemp, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtestadoemp, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tablaestadoempMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaestadoempMouseClicked
        Integer ID = (Integer) tablaestadoemp.getValueAt(tablaestadoemp.getSelectedRow(), 0);
        String Nombre = (String) tablaestadoemp.getValueAt(tablaestadoemp.getSelectedRow(), 1);

        txtcodigoemp.setText(ID.toString());
        txtestadoemp.setText(Nombre);

    }//GEN-LAST:event_tablaestadoempMouseClicked

    private void txtestadoempKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtestadoempKeyPressed

    }//GEN-LAST:event_txtestadoempKeyPressed

    private void txtestadoempKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtestadoempKeyTyped

    }//GEN-LAST:event_txtestadoempKeyTyped
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(!txtestadoemp.getText().isEmpty())
        {

            mthestados2 obj = new mthestados2();
            
            obj.setNombre(txtestadoemp.getText());
            obj.setConsulta("insert into estado_empleado(nombre_estado) values(?)");
            if(obj.guardar_estado())
            {
                ...
                try {
                    DefaultTableModel modelo=(DefaultTableModel) tablaestadoemp.getModel();
                    int filas=tablaestadoemp.getRowCount();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!txtcodigoemp.getText().isEmpty())
        {
            if(!txtestadoemp.getText().isEmpty())
            {
                ...
                mthestados2 obj = new mthestados2();
                obj.setCodigo(Integer.parseInt(txtcodigoemp.getText()));
                obj.setNombre(txtestadoemp.getText());
                obj.setConsulta("update estado_empleado set nombre_estado=? where id_estadoem=?");
    ...
    private void btnEliminar_TUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminar_TUActionPerformed
        ...
        if(!txtcodigoemp.getText().isEmpty())
        {
            mthestados2 obj = new mthestados2();
            obj.setCodigo(Integer.parseInt(txtcodigoemp.getText()));
            obj.setConsulta("delete from estado_empleado where id_estadoem = ?");
...
private void limpiar(){
    txtcodigoemp.setText(null);
    txtestadoemp.setText(null);
}
...
//        }
    ...
    public static javax.swing.JTable tablaestadoemp;
