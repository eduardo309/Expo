...
import Clases.mthunidadmedidas;
...
public class unidadesmedidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tablaunidadmedidas = new javax.swing.JTable();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Unidades de medida", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        tablaunidadmedidas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaunidadmedidas.getTableHeader().setReorderingAllowed(false);
        tablaunidadmedidas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaunidadmedidasMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaunidadmedidas);
        if (tablaunidadmedidas.getColumnModel().getColumnCount() > 0) {
            tablaunidadmedidas.getColumnModel().getColumn(0).setMinWidth(0);
            tablaunidadmedidas.getColumnModel().getColumn(0).setMaxWidth(0);
        }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnLimpiar_TU, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(32, 32, 32)
             ...
             || (int)evt.getKeyChar()>=123 && (int)evt.getKeyChar()<=255)
    {
        //Funcion para emitir sonido al ingresar funciones especiales.
         getToolkit().beep();
          //Funcion que borra los caracteres o funciones especiales.
         evt.consume();
     }
    ...
    private void tablaunidadmedidasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaunidadmedidasMouseClicked
       Integer ID = (Integer) tablaunidadmedidas.getValueAt(tablaunidadmedidas.getSelectedRow(), 0);
    String Nombre = (String) tablaunidadmedidas.getValueAt(tablaunidadmedidas.getSelectedRow(), 1);
    
    
    txtcodigo.setText(ID.toString());
    txtnombre.setText(Nombre);
    
    }//GEN-LAST:event_tablaunidadmedidasMouseClicked
    ...
    public static javax.swing.JTable tablaunidadmedidas;
